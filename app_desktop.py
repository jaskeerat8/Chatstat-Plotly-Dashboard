    ...
    html.Div(children=[
        ...
        dbc.Nav(className="sidebar_navlink", children=[
            dbc.NavLink(children=[html.Img(src="https://chatstat-dashboard.s3.ap-southeast-2.amazonaws.com/images/dashboard.png", alt="Dashboard"), html.Span("Dashboard")],
                        href="/desktop/Dashboard", active="exact", className="sidebar_navlink_option"),
            dbc.NavLink(children=[html.Img(src="https://chatstat-dashboard.s3.ap-southeast-2.amazonaws.com/images/analytics.png", alt="Analytics"), html.Span("Analytics")],
                        href="/desktop/Analytics", active="exact", className="sidebar_navlink_option"),
            dbc.NavLink(children=[html.Img(src="https://chatstat-dashboard.s3.ap-southeast-2.amazonaws.com/images/report.png", alt="Report"), html.Span("Report & Logs")],
                        href="/desktop/Report&Logs", active="exact", className="sidebar_navlink_option")
...
# Designing Main App
def init_desktop_app(server):
    app = Dash(__name__, server=server, url_base_pathname='/desktop/', update_title=None, suppress_callback_exceptions=True, external_stylesheets=["https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;500;600;700&display=swap", dbc.themes.BOOTSTRAP])
    ...
    def display_page(pathname):
        if pathname == '/desktop' or pathname == '/desktop/' or pathname == '/desktop/Dashboard':
            return [filters, kpi_cards, dashboard_charts]
        elif pathname == '/desktop/Analytics':
            return [analytic_charts]
        elif pathname == '/desktop/Report&Logs':
            return [report_page]
        return html.Div([
