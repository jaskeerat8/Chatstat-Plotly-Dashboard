        ...
        dcc.Tab(label="Analytical View 📊", value="analytics", style={"textAlign": "center", "border": "2px solid #117200", "backgroundColor": "rgb(198,240,215)", "color": "black"},
                ...
                html.Div([
                    ...
                    dmc.Footer(height=60, fixed=False,
                        children=[
                            html.Div(
                                style={ "display": "flex", "align-items": "center", "justify-content": "center", "text-align": "center", "color": "#ffffff", "height": "100%"},
                                children=[
                                    html.Hr(style={"opacity": "unset", "opacity": "1", "color": "#ffffff", "width": "40%", "display": "inline-block", "borderWidth": "3px", "borderRadius": "10px"}),
                                    dmc.Text("Chatstat Analytics", style={"display": "inline-block", "font-size": "18px", "font-weight": "bold", "width": "15%"}),
                                    html.Hr(style={"opacity": "unset", "opacity": "1", "color": "#ffffff", "width": "40%", "display": "inline-block", "borderWidth": "3px", "borderRadius": "10px"}),
                                ],
                            )
