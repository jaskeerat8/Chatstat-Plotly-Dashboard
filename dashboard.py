...
session = boto3.session.Session(aws_access_key_id="AKIAQBTIQ6VDCHHWNCNV",
                                aws_secret_access_key="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")
...
def update_card_platform_kpi(interval, user_child):
    ...
    card_platform_df = card_platform_df.groupby(by=["name_childrens", "platform_contents"], as_index=False)[
        "id_contents"].nunique()
